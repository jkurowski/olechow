    ...
    <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12 col-xl-8">
                <img src="{{ asset('/gfx/logo-footer.png') }}" alt="" class="footer-logo">
...
<link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@300;400;700;900&family=Montserrat:wght@400;500;600&display=swap" rel="stylesheet">
